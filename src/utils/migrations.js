...
function createTables() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield (0, db_1.default) `CREATE EXTENSION IF NOT EXISTS "uuid-ossp"`;
            // Users table
...
`;
     ...
     `;
            yield (0, db_1.default) `CREATE INDEX IF NOT EXISTS idx_password_reset_tokens_user_id ON password_reset_tokens(user_id);
    `;
    ...
    `;
            logger_1.default.info('All database tables created successfully');
        }
        catch (error) {
            logger_1.default.error('Error creating database tables', {
